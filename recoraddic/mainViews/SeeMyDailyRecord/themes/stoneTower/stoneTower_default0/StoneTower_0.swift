...
//        let dailyRecords:[DailyRecord] = dailyRecordSet.dailyRecords!.sorted(by: { dr1, dr2 in
//            dr1.date < dr2.date
//        }).filter({!$0.hide})
...
//        let numberOfStonePredicate = #Predicate<DailyRecord>{ dailyRecord in
//            dailyRecord.visualValue3 != nil // because visualValue3 is calculated in last order
//        }
//        let numberOfStones:Int = try! dailyRecords.filter(numberOfStonePredicate).count
                                    ...
                                    ForEach((0...lastIndexOfRecordStone).reversed(), id:\.self) { index in
                                        ...
                                        GeometryReader { geometry3 in
                                            ...
                                            ZStack {
                                                ...
                                                .padding(.trailing, geoWidth/2 - width/2)
                                                .padding(.vertical, 0)
//                                                .opacity(0.8)
                                                .onTapGesture {
                                                    if isSelectedRecord {
                                                ...
                                                //                                                    .font(isOnCenter ? .footnote : .subheadline)
                                                    ...
                                                    .position(x:geoWidth*0.77, y: height/2)
...
struct StoneTower_0_popUp_ChangeStyleView: View {
